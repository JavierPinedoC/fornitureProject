...
if ($id == null) {
    ...
    $sql = "SELECT * FROM inventariobases inb NATURAL JOIN basenombre bn NATURAL JOIN madera ma NATURAL JOIN tela te NATURAL JOIN color co NATURAL JOIN tamaniobase tamb WHERE baseid = ?;";
    $q = $pdo->prepare($sql);
